...
float TotalApostado(Apuesta apuestas[], int n, int pos)
{
    ...
    return apuestas[pos].monto +
           TotalApostado(apuestas, n, pos + 1);
}

int BuscarApuesta(Apuesta apuestas[],
                  int n,
                  int codigo,
                  int pos)
{
...
void GuardarApuestas(Apuesta apuestas[],
                     int n,
                     int pos,
                     ofstream &archivo)
{
...
void ReporteUsuario(Apuesta apuestas[],
                    int n,
                    string usuario,
                    int pos)
{
...
float TotalUsuario(Apuesta apuestas[],
                   int n,
                   string usuario,
                   int pos)
{
...
void BuscarUsuario(Apuesta apuestas[],
                   int n)
{
    string usuario;
